  ...
  return (
    <div style={{ maxHeight: 110, overflowY: "auto", scrollbarWidth: "none" }}>
      {events?.slice(0, 8).map((e) => (
        ...
        >
          <span style={{ color: e.color, fontSize: 10, flexShrink: 0 }}>
            {e.icon}
          </span>
          <span
            style={{
          ...
          <span style={{ fontSize: 9, color: "#4a4a6a", flexShrink: 0 }}>
            {timeAgo(e.ts)}
          </span>
        </div>
      ))}
  ...
  return (
    ...
    >
      {tickers.map((sym) => (
        ...
        >
          <span
            style={{ color: "#7c7c9a", fontSize: 11, letterSpacing: "0.05em" }}
          >
            {sym}
          </span>
...
function MarketStatusBar() {
  ...
  if (!mounted)
    return (
      <div
        style={{ height: 27, flexShrink: 0, borderBottom: "1px solid #1e1e2e" }}
      />
    );
  return (
    <div
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <span
          style={{
            color: status.isOpen ? "#22c55e" : "#f59e0b",
            fontWeight: 600,
          }}
        >
          {status.label}
...
export default function DashboardPage() {
  ...
  const newsFlat =
    newsData?.groups?.flatMap((g) => g.articles.slice(0, 2)) ?? [];
          ...
          <div style={PANEL}>
            <div style={{ ...LABEL, justifyContent: "space-between" }}>
              ...
              {!!positions?.length && (
                <button
                  onClick={() => {
                    if (window.confirm("Liquidate all positions?"))
                      doLiquidateAll();
                  }}
                  style={{
                    fontSize: 9,
            ...
            >
              {positions?.length ? (
                ...
                <div
                  style={{ color: "#4a4a6a", fontSize: 11, padding: "6px 0" }}
                >
                  no open positions
                </div>
              )}
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ textAlign: "right" }}>
                        ...
                        {(t as any).stop_loss && (
                          ...
                          >
                            SL {fmt$$((t as any).stop_loss)} · TP{" "}
                            {fmt$$((t as any).take_profit)}
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background = isExit
                            ? "#4a1a1a"
                            : "#1a4a2a";
                        }}
                        onMouseLeave={(e) => {
                ...
                {newsFlat.slice(0, 6).map((a, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {a.source}
                        {a.tickers?.length ? ` · ${a.tickers[0]}` : ""}
                      </span>
                      {(a as any).signal_class &&
                        (a as any).signal_class !== "NOISE" &&
                        (a as any).signal_class !== "MONITORING" && (
                          <span
                            style={{
                              fontSize: 8,
                              padding: "1px 4px",
                              borderRadius: 2,
                              ...((a as any).signal_class === "CRITICAL"
                                ? {
                                    background: "#2e0d0d",
                                    color: "#ef4444",
                                    border: "1px solid #4a1a1a",
