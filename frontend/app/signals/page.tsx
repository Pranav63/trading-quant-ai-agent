...
export default function SignalsPage() {
  const { data: signals, isLoading } = useQuery({
    queryKey: ["signals"], queryFn: getSignals,
    ...
    <div style={{
      ...
      <style>{`
        ...
        .filter-btn {
          ...
          font-family: inherit; border: 1px solid #1e1e2e; background: #0d0d14; color: #4a4a6a;
        }
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        <div>
          ...
          <div style={{ fontSize: 11, color: "#4a4a6a", marginTop: 2 }}>
            click any row to expand full reasoning + indicator details
          </div>
        </div>
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          ...
          <span style={{ marginLeft: 8, fontSize: 10, color: "#4a4a6a" }}>
            {filtered?.length ?? 0} signals
          </span>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          display: "grid",
          gridTemplateColumns: "80px 60px 80px 1fr 100px",
          borderBottom: "1px solid #1e1e2e",
          padding: "10px 16px",
          flexShrink: 0,
          background: "#0d0d14",
        }}>
          {["signal", "ticker", "conf", "reasoning", "time"].map((h, i) => (
            <div key={h} style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", scrollbarWidth: "none", minHeight: 0 }}>
          ...
          {filtered?.map(s => {
            ...
            const indicators = (s as any).raw_llm_response?.indicators
            const atrPct = (s as any).raw_llm_response?.atr_pct
            const stopDist = (s as any).raw_llm_response?.stop_loss_distance
              ...
              <div key={s.id} style={{ borderBottom: "1px solid #1e1e2e" }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: "11px 16px",
                    alignItems: "center",
                    background: isOpen ? "#111118" : undefined,
                  }}
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
                    ...
                    <span style={{ fontSize: 10, color: "#2a2a4a", flexShrink: 0 }}>
                      {isOpen ? "▲" : "▼"}
                    </span>
                  </div>
                  <div style={{ textAlign: "right", color: "#4a4a6a", fontSize: 10 }}>
                ...
                {/* Expanded detail */}
                {isOpen && (
                  <div className="sig-expanded" style={{
                    ...
                    <div>
                      <div style={{
                        fontSize: 9, color: "#4a4a6a", letterSpacing: "0.1em",
                        textTransform: "uppercase", marginBottom: 6,
                      }}>
                        full reasoning
                      </div>
                      <div style={{
                        fontSize: 12, color: "#c0c0d8", lineHeight: 1.6,
                        ...
                        <div style={{
                          ...
                          {indicators ? (
                            <>
                              ...
                              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                                  <span style={{ fontSize: 10, color: "#4a4a6a" }}>
                                    {indicators.ema9_hourly ?? "—"} / {indicators.ema21_hourly ?? "—"}
                                  </span>
                              ...
                              <div style={{
                                marginTop: 2, paddingTop: 8, borderTop: "1px solid #1e1e2e",
                                display: "flex", justifyContent: "space-between", alignItems: "center",
                              }}>
                                <span style={{ fontSize: 11, color: "#4a4a6a" }}>votes</span>
                                <span style={{ fontSize: 12, fontWeight: 600, color: "#e2e2e8" }}>
                                  {indicators.votes} / {indicators.total}
                                </span>
                              </div>
                            </>
                          ) : (
                      ...
                      <div>
                        ...
                        <div style={{
                          ...
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            ...
                            <span style={{
                              fontSize: 11,
                              color: atrPct > 3 ? "#ef4444" : atrPct < 0.2 ? "#f59e0b" : "#22c55e",
                            }}>
                          ...
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            ...
                            <span style={{ fontSize: 11, color: "#e2e2e8" }}>
                              {stopDist ? `$${stopDist}` : "—"}
                            </span>
                          </div>
                          {indicators?.atr_veto ? (
                            ...
                            <div style={{
                              marginTop: 2, padding: "6px 8px", borderRadius: 4,
                              background: "#0d2e1a", border: "1px solid #1a4a2a",
                        ...
                        <div style={{
                          ...
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                            ...
                            <span style={{ fontSize: 11, color: "#7c7cdc" }}>
                              ~{Math.min(100, Math.round(s.confidence * 100 / 0.6))}%
                            </span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                            <span style={{ fontSize: 11, color: "#4a4a6a" }}>indicators (40%)</span>
                            <span style={{ fontSize: 11, color: "#7c7cdc" }}>
                              {indicators ? `${Math.round(indicators.indicator_score * 100)}%` : "—"}
                            </span>
                          </div>
