...
function ConfBar({ value }: { value: number }) {
  ...
  const color =
    value >= 0.8 ? "#22c55e" : value >= 0.65 ? "#f59e0b" : "#6a6a8a";
  return (
...
function BuyPressureBadge({
  ...
  const aligned =
    (signalType === "BUY" && bullish) || (signalType === "SELL" && bearish);
  return (
    <span
      style={{
        fontSize: 9,
    ...
    >
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 11, color: "#4a4a6a", marginTop: 2 }}>
            click any row to expand reasoning + indicator details
          </div>
        </div>
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          <span style={{ fontSize: 10, color: "#4a4a6a", marginRight: 4 }}>
            filter:
          </span>
      ...
      >
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns: "80px 60px 90px 120px 1fr 100px",
        ...
        >
          {["signal", "ticker", "conf", "pressure", "reasoning", "time"].map(
            (h, i) => (
              <div
                key={h}
                style={{
        ...
        >
          ...
          {mounted &&
            filtered?.map((s) => {
              ...
              const stopDist =
                (s as any).raw_llm_response?.stop_loss_distance ??
                indicators?.stop_loss_distance;
                          ...
                          >
                            {indicators ? (
                              <>
                                ...
                                >
                                  <span
                                    style={{ fontSize: 11, color: "#4a4a6a" }}
                                  >
                                    RSI(14)
                                  </span>
                                  <div
                                  ...
                                  >
                                    <span
                                      style={{ fontSize: 11, color: "#e2e2e8" }}
                                    >
                                      {indicators.rsi ?? "—"}
                                    </span>
                                    <IndicatorPill
                                      ok={indicators.rsi_ok}
                                      label={
                                        indicators.rsi_ok ? "pass" : "fail"
                                      }
                                    />
                                  </div>
                                </div>
                                ...
                                >
                                  ...
                                  >
                                    <span
                                      style={{ fontSize: 10, color: "#4a4a6a" }}
                                    >
                                      {indicators.ema9_hourly ?? "—"} /{" "}
                                      {indicators.ema21_hourly ?? "—"}
                                    </span>
                                    <IndicatorPill
                                      ok={indicators.ema_ok}
                                      label={
                                        indicators.ema_ok ? "pass" : "fail"
                                      }
                                    />
                                  </div>
                                </div>
                                ...
                                >
                                  ...
                                  >
                                    <span
                                      style={{ fontSize: 11, color: "#e2e2e8" }}
                                    >
                                      {indicators.weighted_avg_price ?? "—"}
                                    </span>
                                    <IndicatorPill
                                      ok={indicators.wav_ok}
                                      label={
                                        indicators.wav_ok ? "pass" : "fail"
                                      }
                                    />
                                  </div>
                                </div>
                                ...
                                >
                                  ...
                                  <IndicatorPill
                                    ok={indicators.volume_spike}
                                    label={
                                      indicators.volume_spike ? "yes" : "no"
                                    }
                                  />
                                </div>
                                <div
                          ...
                          >
                            ...
                            >
                              ...
                              <span style={{ fontSize: 11, color: "#7c7cdc" }}>
                                ...
                                {Math.min(
                                  100,
                                  Math.round((s.confidence * 100) / 0.6),
                                )}
                                %
                              </span>
                            </div>
                            ...
                            >
                              ...
                              <span style={{ fontSize: 11, color: "#7c7cdc" }}>
                                {indicators?.indicator_score != null
                                  ? `${Math.round(indicators.indicator_score * 100)}%`
                                  : "—"}
                              </span>
                            </div>
                            ...
                            {(s as any).pending_trade && (
                              <>
                                <div
                                  style={{ height: 1, background: "#1e1e2e" }}
                                />
                                <div
                                  style={{
                                    display: "flex",
