...
const INGESTION_STEPS = [
  { label: "fetch news", detail: "Finnhub, NewsAPI, Reuters, WSJ, FT, FRED" },
  {
    ...
    detail: "CRITICAL / ELEVATED / MONITORING / NOISE",
  },
...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Logo */}
      <div
        style={{ padding: "20px 16px 16px", borderBottom: "1px solid #1e1e2e" }}
      >
        <div
          style={{
            fontSize: 15,
            ...
            {INGESTION_STEPS.map((step, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 9, color: "#3a3a5a", marginTop: 1 }}>
                    {step.detail}
                  </div>
                </div>
              </div>
